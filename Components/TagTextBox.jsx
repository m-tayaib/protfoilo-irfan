...
export default function TagTextBox({ title, delay, id, x }) {
  return (
    <motion.div
      ...
      className="px-2 rounded-lg flex mt-5 py-4 bg-white/50 dark:bg-slate-900/70 backdrop-blur-md border border-white/40 dark:border-slate-700 justify-start items-center shadow-md ml-1 text-sm sm:text-base md:text-lg lg:text-xl font-normal gap-2 text-gray-600 dark:text-slate-300 capitalize transition-colors duration-300"
    >
